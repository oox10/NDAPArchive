	  ...
	  <div class='manual_continer'>	
	    ...
	    <ul class='main_manual'>
		  ...
		  <li class='option_group'>
		    <div class='opgroup_name '>
			  <i class="fa fa-calendar-check-o" aria-hidden="true"></i> <span>詮釋資料管理</span>
			</div>
		    <ul class='group_manuel'>
			  ...
			  <li  title='資料管理'	 class='option func_activate'	id='Meta'	><i class="fa fa-pencil-square-o" aria-hidden="true"></i> <span >資料編輯</span> </li>
			  <?php endif; ?>
			</ul>
		  </li>
		  <li>
