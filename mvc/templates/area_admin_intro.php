			  <div class='system_descrip_block'>
				<div class='desc_border'>系統資訊</div>
				  <p class='format_desc'>
					<ol class='test_list'>
					  <li><span class='test_title'>主管機關</span>:<a href='http://www.tpa.gov.tw/' target='_blank'> 臺灣省諮議會 </a></li>
					  <li><span class='test_title'>承辦單位</span>:<a href='http://www.digital.ntu.edu.tw/' target='_blank'> 國立臺灣大學數位人文研究中心 </a></li>
					</ol>
				  </p>
