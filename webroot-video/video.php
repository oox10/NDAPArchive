<?php 
  ...
  */
  ...
  if(isset($_SESSION[_SYSTEM_NAME_SHORT]['CLIENT']['LOGIN_TOKEN'])){
	$video_location = is_file($_SESSION[_SYSTEM_NAME_SHORT]['Image_Access_Add'].$_REQUEST['src']) ?$_SESSION[_SYSTEM_NAME_SHORT]['Image_Access_Add'].$_REQUEST['src'] :_SYSTEM_ROOT_PATH.'SystemFile/System-Search_Query-Display_ImageNotFound.jpg';
	ob_get_clean();
